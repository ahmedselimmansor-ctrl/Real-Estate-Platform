...
ENV['JWT_ISSUER'] = 'nawy-api'
ENV['JWT_AUDIENCE'] = 'nawy-clients'
ENV['FRONTEND_URL'] = 'https://localhost'
ENV['DATABASE_URL'] ||= 'postgresql://nawy:nawy_password@localhost:5432/nawy?schema=public'
ENV['MONGO_URI'] ||= 'mongodb://localhost:27017/nawy'
